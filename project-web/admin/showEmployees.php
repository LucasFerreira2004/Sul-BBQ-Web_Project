...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active">
					<a class="nav-link" href="./dashboard.php">Tab. de administradores</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<li><a class="dropdown-item" href="../php/logout_proc.php"><span class="text-danger">Sair</span></a></li>
					</ul>
				</li>
			</ul>
		</div>
	...
	<div class="container mt-3">
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<td>41241039</td>
				<td>jairo@corp.com.br</td>
				<td>Jairo Holanda da Silva</td>
				<td>Segurança</td>
				<td>R$ 4.000,00</td>
			</tbody>
		</table>
